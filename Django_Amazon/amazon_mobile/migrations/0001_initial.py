    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_sim', models.CharField(choices=[('SIM1', 'SIM1'), ('SIM2', 'SIM2')], max_length=100)),
                ...
                ('main_camera_video', models.CharField(max_length=200)),
